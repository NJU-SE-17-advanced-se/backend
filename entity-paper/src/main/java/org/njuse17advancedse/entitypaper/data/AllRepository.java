...
public class AllRepository {
    ...
    public List<String> getPapersByResearcher(String researcher){
        String sql="select pid from `paper_researcher` where rid='" + researcher + "';";
        return jdbcTemplate.queryForList(sql,String.class);
    }

    @Transactional(readOnly = true)
    public List<String> getPapersByPublication(String publication){
        String sql = "select id from `paper` where publication_id='" + publication + "';";
        return jdbcTemplate.queryForList(sql,String.class);
    }

    @Transactional(readOnly = true)
    public List<String> getPapersByDate(String date){
        String sql= "select id from `paper` where publication_date='"+date+"';";
        return jdbcTemplate.queryForList(sql,String.class);
    }

    @Transactional(readOnly = true)
    public List<String> getPapersByResearcherAndPublication(String researcher,String publication){
        String sql="select paper.id from `paper`,`paper_researcher` where paper.publication_id='" +
                publication + "'and paper.id=paper_researcher.pid and paper_researcher.rid='" + researcher +"';";
        return jdbcTemplate.queryForList(sql,String.class);
    }

    @Transactional(readOnly = true)
    public List<String> getPapersByResearcherAndDate(String researcher,String date){
        String sql="select paper.id from `paper`,`paper_researcher` where paper.publication_date='" +
                date + "'and paper.id=paper_researcher.pid and paper_researcher.rid='" + researcher +"';";
        return jdbcTemplate.queryForList(sql,String.class);
    }

    @Transactional(readOnly = true)
    public List<String> getPapersByPublicationAndDate(String publication,String date){
        String sql="select id from `paper` where publication_id='" +
                publication + "' and publication_date='" + date + "';";
        return jdbcTemplate.queryForList(sql,String.class);
    }

    @Transactional
    public List<String> getPapersByResearcherAndPublicationAndDate(String researcher,String publication,String date){
        String sql =
                "select paper.id from `paper`,`paper_researcher` where paper.publication_date='" + date +
                        "' and paper.publication_id='" + publication +
                        "' and paper.id=paper_researcher.pid and paper_researcher.rid='" + researcher + "';";
        return jdbcTemplate.queryForList(sql,String.class);
    }
    ...
    public IPaperBasic getPaperBasic(String paperId){
        String sql="select paper.*, group_concat(distinct paper_researcher.rid) as researchers" +
